...
public class CharacterEntityReference extends CharacterReference {
	...
	static {
		NAME_TO_CODE_POINT_MAP.put("nbsp",Integer.valueOf(_nbsp));
		NAME_TO_CODE_POINT_MAP.put("iexcl",Integer.valueOf(_iexcl));
		NAME_TO_CODE_POINT_MAP.put("cent",Integer.valueOf(_cent));
		NAME_TO_CODE_POINT_MAP.put("pound",Integer.valueOf(_pound));
		NAME_TO_CODE_POINT_MAP.put("curren",Integer.valueOf(_curren));
		NAME_TO_CODE_POINT_MAP.put("yen",Integer.valueOf(_yen));
		NAME_TO_CODE_POINT_MAP.put("brvbar",Integer.valueOf(_brvbar));
		NAME_TO_CODE_POINT_MAP.put("sect",Integer.valueOf(_sect));
		NAME_TO_CODE_POINT_MAP.put("uml",Integer.valueOf(_uml));
		NAME_TO_CODE_POINT_MAP.put("copy",Integer.valueOf(_copy));
		NAME_TO_CODE_POINT_MAP.put("ordf",Integer.valueOf(_ordf));
		NAME_TO_CODE_POINT_MAP.put("laquo",Integer.valueOf(_laquo));
		NAME_TO_CODE_POINT_MAP.put("not",Integer.valueOf(_not));
		NAME_TO_CODE_POINT_MAP.put("shy",Integer.valueOf(_shy));
		NAME_TO_CODE_POINT_MAP.put("reg",Integer.valueOf(_reg));
		NAME_TO_CODE_POINT_MAP.put("macr",Integer.valueOf(_macr));
		NAME_TO_CODE_POINT_MAP.put("deg",Integer.valueOf(_deg));
		NAME_TO_CODE_POINT_MAP.put("plusmn",Integer.valueOf(_plusmn));
		NAME_TO_CODE_POINT_MAP.put("sup2",Integer.valueOf(_sup2));
		NAME_TO_CODE_POINT_MAP.put("sup3",Integer.valueOf(_sup3));
		NAME_TO_CODE_POINT_MAP.put("acute",Integer.valueOf(_acute));
		NAME_TO_CODE_POINT_MAP.put("micro",Integer.valueOf(_micro));
		NAME_TO_CODE_POINT_MAP.put("para",Integer.valueOf(_para));
		NAME_TO_CODE_POINT_MAP.put("middot",Integer.valueOf(_middot));
		NAME_TO_CODE_POINT_MAP.put("cedil",Integer.valueOf(_cedil));
		NAME_TO_CODE_POINT_MAP.put("sup1",Integer.valueOf(_sup1));
		NAME_TO_CODE_POINT_MAP.put("ordm",Integer.valueOf(_ordm));
		NAME_TO_CODE_POINT_MAP.put("raquo",Integer.valueOf(_raquo));
		NAME_TO_CODE_POINT_MAP.put("frac14",Integer.valueOf(_frac14));
		NAME_TO_CODE_POINT_MAP.put("frac12",Integer.valueOf(_frac12));
		NAME_TO_CODE_POINT_MAP.put("frac34",Integer.valueOf(_frac34));
		NAME_TO_CODE_POINT_MAP.put("iquest",Integer.valueOf(_iquest));
		NAME_TO_CODE_POINT_MAP.put("Agrave",Integer.valueOf(_Agrave));
		NAME_TO_CODE_POINT_MAP.put("Aacute",Integer.valueOf(_Aacute));
		NAME_TO_CODE_POINT_MAP.put("Acirc",Integer.valueOf(_Acirc));
		NAME_TO_CODE_POINT_MAP.put("Atilde",Integer.valueOf(_Atilde));
		NAME_TO_CODE_POINT_MAP.put("Auml",Integer.valueOf(_Auml));
		NAME_TO_CODE_POINT_MAP.put("Aring",Integer.valueOf(_Aring));
		NAME_TO_CODE_POINT_MAP.put("AElig",Integer.valueOf(_AElig));
		NAME_TO_CODE_POINT_MAP.put("Ccedil",Integer.valueOf(_Ccedil));
		NAME_TO_CODE_POINT_MAP.put("Egrave",Integer.valueOf(_Egrave));
		NAME_TO_CODE_POINT_MAP.put("Eacute",Integer.valueOf(_Eacute));
		NAME_TO_CODE_POINT_MAP.put("Ecirc",Integer.valueOf(_Ecirc));
		NAME_TO_CODE_POINT_MAP.put("Euml",Integer.valueOf(_Euml));
		NAME_TO_CODE_POINT_MAP.put("Igrave",Integer.valueOf(_Igrave));
		NAME_TO_CODE_POINT_MAP.put("Iacute",Integer.valueOf(_Iacute));
		NAME_TO_CODE_POINT_MAP.put("Icirc",Integer.valueOf(_Icirc));
		NAME_TO_CODE_POINT_MAP.put("Iuml",Integer.valueOf(_Iuml));
		NAME_TO_CODE_POINT_MAP.put("ETH",Integer.valueOf(_ETH));
		NAME_TO_CODE_POINT_MAP.put("Ntilde",Integer.valueOf(_Ntilde));
		NAME_TO_CODE_POINT_MAP.put("Ograve",Integer.valueOf(_Ograve));
		NAME_TO_CODE_POINT_MAP.put("Oacute",Integer.valueOf(_Oacute));
		NAME_TO_CODE_POINT_MAP.put("Ocirc",Integer.valueOf(_Ocirc));
		NAME_TO_CODE_POINT_MAP.put("Otilde",Integer.valueOf(_Otilde));
		NAME_TO_CODE_POINT_MAP.put("Ouml",Integer.valueOf(_Ouml));
		NAME_TO_CODE_POINT_MAP.put("times",Integer.valueOf(_times));
		NAME_TO_CODE_POINT_MAP.put("Oslash",Integer.valueOf(_Oslash));
		NAME_TO_CODE_POINT_MAP.put("Ugrave",Integer.valueOf(_Ugrave));
		NAME_TO_CODE_POINT_MAP.put("Uacute",Integer.valueOf(_Uacute));
		NAME_TO_CODE_POINT_MAP.put("Ucirc",Integer.valueOf(_Ucirc));
		NAME_TO_CODE_POINT_MAP.put("Uuml",Integer.valueOf(_Uuml));
		NAME_TO_CODE_POINT_MAP.put("Yacute",Integer.valueOf(_Yacute));
		NAME_TO_CODE_POINT_MAP.put("THORN",Integer.valueOf(_THORN));
		NAME_TO_CODE_POINT_MAP.put("szlig",Integer.valueOf(_szlig));
		NAME_TO_CODE_POINT_MAP.put("agrave",Integer.valueOf(_agrave));
		NAME_TO_CODE_POINT_MAP.put("aacute",Integer.valueOf(_aacute));
		NAME_TO_CODE_POINT_MAP.put("acirc",Integer.valueOf(_acirc));
		NAME_TO_CODE_POINT_MAP.put("atilde",Integer.valueOf(_atilde));
		...
		NAME_TO_CODE_POINT_MAP.put("otilde",Integer.valueOf(_otilde));
		NAME_TO_CODE_POINT_MAP.put("ouml",Integer.valueOf(_ouml));
		NAME_TO_CODE_POINT_MAP.put("divide",Integer.valueOf(_divide));
		NAME_TO_CODE_POINT_MAP.put("oslash",Integer.valueOf(_oslash));
		NAME_TO_CODE_POINT_MAP.put("ugrave",Integer.valueOf(_ugrave));
		NAME_TO_CODE_POINT_MAP.put("uacute",Integer.valueOf(_uacute));
		NAME_TO_CODE_POINT_MAP.put("ucirc",Integer.valueOf(_ucirc));
		...
		NAME_TO_CODE_POINT_MAP.put("yacute",Integer.valueOf(_yacute));
		NAME_TO_CODE_POINT_MAP.put("thorn",Integer.valueOf(_thorn));
		NAME_TO_CODE_POINT_MAP.put("yuml",Integer.valueOf(_yuml));
		NAME_TO_CODE_POINT_MAP.put("fnof",Integer.valueOf(_fnof));
		NAME_TO_CODE_POINT_MAP.put("Alpha",Integer.valueOf(_Alpha));
		NAME_TO_CODE_POINT_MAP.put("Beta",Integer.valueOf(_Beta));
		NAME_TO_CODE_POINT_MAP.put("Gamma",Integer.valueOf(_Gamma));
		NAME_TO_CODE_POINT_MAP.put("Delta",Integer.valueOf(_Delta));
		NAME_TO_CODE_POINT_MAP.put("Epsilon",Integer.valueOf(_Epsilon));
		NAME_TO_CODE_POINT_MAP.put("Zeta",Integer.valueOf(_Zeta));
		NAME_TO_CODE_POINT_MAP.put("Eta",Integer.valueOf(_Eta));
		NAME_TO_CODE_POINT_MAP.put("Theta",Integer.valueOf(_Theta));
		NAME_TO_CODE_POINT_MAP.put("Iota",Integer.valueOf(_Iota));
		NAME_TO_CODE_POINT_MAP.put("Kappa",Integer.valueOf(_Kappa));
		NAME_TO_CODE_POINT_MAP.put("Lambda",Integer.valueOf(_Lambda));
		NAME_TO_CODE_POINT_MAP.put("Mu",Integer.valueOf(_Mu));
		NAME_TO_CODE_POINT_MAP.put("Nu",Integer.valueOf(_Nu));
		NAME_TO_CODE_POINT_MAP.put("Xi",Integer.valueOf(_Xi));
		NAME_TO_CODE_POINT_MAP.put("Omicron",Integer.valueOf(_Omicron));
		NAME_TO_CODE_POINT_MAP.put("Pi",Integer.valueOf(_Pi));
		NAME_TO_CODE_POINT_MAP.put("Rho",Integer.valueOf(_Rho));
		NAME_TO_CODE_POINT_MAP.put("Sigma",Integer.valueOf(_Sigma));
		NAME_TO_CODE_POINT_MAP.put("Tau",Integer.valueOf(_Tau));
		NAME_TO_CODE_POINT_MAP.put("Upsilon",Integer.valueOf(_Upsilon));
		NAME_TO_CODE_POINT_MAP.put("Phi",Integer.valueOf(_Phi));
		NAME_TO_CODE_POINT_MAP.put("Chi",Integer.valueOf(_Chi));
		NAME_TO_CODE_POINT_MAP.put("Psi",Integer.valueOf(_Psi));
		NAME_TO_CODE_POINT_MAP.put("Omega",Integer.valueOf(_Omega));
		NAME_TO_CODE_POINT_MAP.put("alpha",Integer.valueOf(_alpha));
		NAME_TO_CODE_POINT_MAP.put("beta",Integer.valueOf(_beta));
		NAME_TO_CODE_POINT_MAP.put("gamma",Integer.valueOf(_gamma));
		NAME_TO_CODE_POINT_MAP.put("delta",Integer.valueOf(_delta));
		...
		NAME_TO_CODE_POINT_MAP.put("pi",Integer.valueOf(_pi));
		NAME_TO_CODE_POINT_MAP.put("rho",Integer.valueOf(_rho));
		NAME_TO_CODE_POINT_MAP.put("sigmaf",Integer.valueOf(_sigmaf));
		NAME_TO_CODE_POINT_MAP.put("sigma",Integer.valueOf(_sigma));
		NAME_TO_CODE_POINT_MAP.put("tau",Integer.valueOf(_tau));
		NAME_TO_CODE_POINT_MAP.put("upsilon",Integer.valueOf(_upsilon));
		NAME_TO_CODE_POINT_MAP.put("phi",Integer.valueOf(_phi));
		...
		NAME_TO_CODE_POINT_MAP.put("psi",Integer.valueOf(_psi));
		NAME_TO_CODE_POINT_MAP.put("omega",Integer.valueOf(_omega));
		NAME_TO_CODE_POINT_MAP.put("thetasym",Integer.valueOf(_thetasym));
		NAME_TO_CODE_POINT_MAP.put("upsih",Integer.valueOf(_upsih));
		NAME_TO_CODE_POINT_MAP.put("piv",Integer.valueOf(_piv));
		NAME_TO_CODE_POINT_MAP.put("bull",Integer.valueOf(_bull));
		NAME_TO_CODE_POINT_MAP.put("hellip",Integer.valueOf(_hellip));
		NAME_TO_CODE_POINT_MAP.put("prime",Integer.valueOf(_prime));
		NAME_TO_CODE_POINT_MAP.put("Prime",Integer.valueOf(_Prime));
		NAME_TO_CODE_POINT_MAP.put("oline",Integer.valueOf(_oline));
		NAME_TO_CODE_POINT_MAP.put("frasl",Integer.valueOf(_frasl));
		NAME_TO_CODE_POINT_MAP.put("weierp",Integer.valueOf(_weierp));
		NAME_TO_CODE_POINT_MAP.put("image",Integer.valueOf(_image));
		NAME_TO_CODE_POINT_MAP.put("real",Integer.valueOf(_real));
		NAME_TO_CODE_POINT_MAP.put("trade",Integer.valueOf(_trade));
		NAME_TO_CODE_POINT_MAP.put("alefsym",Integer.valueOf(_alefsym));
		NAME_TO_CODE_POINT_MAP.put("larr",Integer.valueOf(_larr));
		NAME_TO_CODE_POINT_MAP.put("uarr",Integer.valueOf(_uarr));
		NAME_TO_CODE_POINT_MAP.put("rarr",Integer.valueOf(_rarr));
		NAME_TO_CODE_POINT_MAP.put("darr",Integer.valueOf(_darr));
		NAME_TO_CODE_POINT_MAP.put("harr",Integer.valueOf(_harr));
		NAME_TO_CODE_POINT_MAP.put("crarr",Integer.valueOf(_crarr));
		NAME_TO_CODE_POINT_MAP.put("lArr",Integer.valueOf(_lArr));
		NAME_TO_CODE_POINT_MAP.put("uArr",Integer.valueOf(_uArr));
		NAME_TO_CODE_POINT_MAP.put("rArr",Integer.valueOf(_rArr));
		NAME_TO_CODE_POINT_MAP.put("dArr",Integer.valueOf(_dArr));
		NAME_TO_CODE_POINT_MAP.put("hArr",Integer.valueOf(_hArr));
		NAME_TO_CODE_POINT_MAP.put("forall",Integer.valueOf(_forall));
		NAME_TO_CODE_POINT_MAP.put("part",Integer.valueOf(_part));
		NAME_TO_CODE_POINT_MAP.put("exist",Integer.valueOf(_exist));
		NAME_TO_CODE_POINT_MAP.put("empty",Integer.valueOf(_empty));
		NAME_TO_CODE_POINT_MAP.put("nabla",Integer.valueOf(_nabla));
		NAME_TO_CODE_POINT_MAP.put("isin",Integer.valueOf(_isin));
		NAME_TO_CODE_POINT_MAP.put("notin",Integer.valueOf(_notin));
		NAME_TO_CODE_POINT_MAP.put("ni",Integer.valueOf(_ni));
		NAME_TO_CODE_POINT_MAP.put("prod",Integer.valueOf(_prod));
		NAME_TO_CODE_POINT_MAP.put("sum",Integer.valueOf(_sum));
		NAME_TO_CODE_POINT_MAP.put("minus",Integer.valueOf(_minus));
		NAME_TO_CODE_POINT_MAP.put("lowast",Integer.valueOf(_lowast));
		NAME_TO_CODE_POINT_MAP.put("radic",Integer.valueOf(_radic));
		NAME_TO_CODE_POINT_MAP.put("prop",Integer.valueOf(_prop));
		NAME_TO_CODE_POINT_MAP.put("infin",Integer.valueOf(_infin));
		NAME_TO_CODE_POINT_MAP.put("ang",Integer.valueOf(_ang));
		NAME_TO_CODE_POINT_MAP.put("and",Integer.valueOf(_and));
		NAME_TO_CODE_POINT_MAP.put("or",Integer.valueOf(_or));
		NAME_TO_CODE_POINT_MAP.put("cap",Integer.valueOf(_cap));
		NAME_TO_CODE_POINT_MAP.put("cup",Integer.valueOf(_cup));
		NAME_TO_CODE_POINT_MAP.put("int",Integer.valueOf(_int));
		NAME_TO_CODE_POINT_MAP.put("there4",Integer.valueOf(_there4));
		NAME_TO_CODE_POINT_MAP.put("sim",Integer.valueOf(_sim));
		NAME_TO_CODE_POINT_MAP.put("cong",Integer.valueOf(_cong));
		NAME_TO_CODE_POINT_MAP.put("asymp",Integer.valueOf(_asymp));
		NAME_TO_CODE_POINT_MAP.put("ne",Integer.valueOf(_ne));
		NAME_TO_CODE_POINT_MAP.put("equiv",Integer.valueOf(_equiv));
		NAME_TO_CODE_POINT_MAP.put("le",Integer.valueOf(_le));
		NAME_TO_CODE_POINT_MAP.put("ge",Integer.valueOf(_ge));
		NAME_TO_CODE_POINT_MAP.put("sub",Integer.valueOf(_sub));
		NAME_TO_CODE_POINT_MAP.put("sup",Integer.valueOf(_sup));
		NAME_TO_CODE_POINT_MAP.put("nsub",Integer.valueOf(_nsub));
		NAME_TO_CODE_POINT_MAP.put("sube",Integer.valueOf(_sube));
		NAME_TO_CODE_POINT_MAP.put("supe",Integer.valueOf(_supe));
		NAME_TO_CODE_POINT_MAP.put("oplus",Integer.valueOf(_oplus));
		NAME_TO_CODE_POINT_MAP.put("otimes",Integer.valueOf(_otimes));
		NAME_TO_CODE_POINT_MAP.put("perp",Integer.valueOf(_perp));
		NAME_TO_CODE_POINT_MAP.put("sdot",Integer.valueOf(_sdot));
		NAME_TO_CODE_POINT_MAP.put("lceil",Integer.valueOf(_lceil));
		NAME_TO_CODE_POINT_MAP.put("rceil",Integer.valueOf(_rceil));
		NAME_TO_CODE_POINT_MAP.put("lfloor",Integer.valueOf(_lfloor));
		NAME_TO_CODE_POINT_MAP.put("rfloor",Integer.valueOf(_rfloor));
		NAME_TO_CODE_POINT_MAP.put("lang",Integer.valueOf(_lang));
		NAME_TO_CODE_POINT_MAP.put("rang",Integer.valueOf(_rang));
		NAME_TO_CODE_POINT_MAP.put("loz",Integer.valueOf(_loz));
		NAME_TO_CODE_POINT_MAP.put("spades",Integer.valueOf(_spades));
		NAME_TO_CODE_POINT_MAP.put("clubs",Integer.valueOf(_clubs));
		NAME_TO_CODE_POINT_MAP.put("hearts",Integer.valueOf(_hearts));
		NAME_TO_CODE_POINT_MAP.put("diams",Integer.valueOf(_diams));
		NAME_TO_CODE_POINT_MAP.put("quot",Integer.valueOf(_quot));
		NAME_TO_CODE_POINT_MAP.put("amp",Integer.valueOf(_amp));
		NAME_TO_CODE_POINT_MAP.put("lt",Integer.valueOf(_lt));
		NAME_TO_CODE_POINT_MAP.put("gt",Integer.valueOf(_gt));
		NAME_TO_CODE_POINT_MAP.put("OElig",Integer.valueOf(_OElig));
		NAME_TO_CODE_POINT_MAP.put("oelig",Integer.valueOf(_oelig));
		NAME_TO_CODE_POINT_MAP.put("Scaron",Integer.valueOf(_Scaron));
		NAME_TO_CODE_POINT_MAP.put("scaron",Integer.valueOf(_scaron));
		NAME_TO_CODE_POINT_MAP.put("Yuml",Integer.valueOf(_Yuml));
		NAME_TO_CODE_POINT_MAP.put("circ",Integer.valueOf(_circ));
		NAME_TO_CODE_POINT_MAP.put("tilde",Integer.valueOf(_tilde));
		NAME_TO_CODE_POINT_MAP.put("ensp",Integer.valueOf(_ensp));
		NAME_TO_CODE_POINT_MAP.put("emsp",Integer.valueOf(_emsp));
		NAME_TO_CODE_POINT_MAP.put("thinsp",Integer.valueOf(_thinsp));
		NAME_TO_CODE_POINT_MAP.put("zwnj",Integer.valueOf(_zwnj));
		NAME_TO_CODE_POINT_MAP.put("zwj",Integer.valueOf(_zwj));
		NAME_TO_CODE_POINT_MAP.put("lrm",Integer.valueOf(_lrm));
		NAME_TO_CODE_POINT_MAP.put("rlm",Integer.valueOf(_rlm));
		NAME_TO_CODE_POINT_MAP.put("ndash",Integer.valueOf(_ndash));
		NAME_TO_CODE_POINT_MAP.put("mdash",Integer.valueOf(_mdash));
		NAME_TO_CODE_POINT_MAP.put("lsquo",Integer.valueOf(_lsquo));
		NAME_TO_CODE_POINT_MAP.put("rsquo",Integer.valueOf(_rsquo));
		NAME_TO_CODE_POINT_MAP.put("sbquo",Integer.valueOf(_sbquo));
		NAME_TO_CODE_POINT_MAP.put("ldquo",Integer.valueOf(_ldquo));
		NAME_TO_CODE_POINT_MAP.put("rdquo",Integer.valueOf(_rdquo));
		NAME_TO_CODE_POINT_MAP.put("bdquo",Integer.valueOf(_bdquo));
		NAME_TO_CODE_POINT_MAP.put("dagger",Integer.valueOf(_dagger));
		NAME_TO_CODE_POINT_MAP.put("Dagger",Integer.valueOf(_Dagger));
		NAME_TO_CODE_POINT_MAP.put("permil",Integer.valueOf(_permil));
		NAME_TO_CODE_POINT_MAP.put("lsaquo",Integer.valueOf(_lsaquo));
		NAME_TO_CODE_POINT_MAP.put("rsaquo",Integer.valueOf(_rsaquo));
		NAME_TO_CODE_POINT_MAP.put("euro",Integer.valueOf(_euro));
		NAME_TO_CODE_POINT_MAP.put("apos",Integer.valueOf(_apos));
