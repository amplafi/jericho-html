 ...
 *   {@link #getValues(String) List getValues(String fieldName)}<br />
...
public final class FormFields extends AbstractCollection {
	...
	/**
	 * Returns a list of the <a href="FormField.html#FieldSubmissionValue">field submission values</a> of all the specified constituent {@linkplain FormField form fields} with the specified {@linkplain FormField#getName() name}.
	 * <p>
	 ...
	 * @return a list of the <a href="FormField.html#FieldSubmissionValue">field submission values</a> of all the specified constituent {@linkplain FormField form field} with the specified {@linkplain FormField#getName() name}, or <code>null</code> if no form field with this name exists.
	 * @see FormField#getValues()
	 */
	public List getValues(final String fieldName) {
	...
	public Map getDataSet() {
		final LinkedHashMap map=new LinkedHashMap((int)(getCount()/0.7));
		for (final Iterator i=iterator(); i.hasNext();) {
			final FormField formField=(FormField)i.next();
			final List values=formField.getValues();
