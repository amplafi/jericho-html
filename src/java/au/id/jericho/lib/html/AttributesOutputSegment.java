...
class AttributesOutputSegment implements OutputSegment {
	...
	public String getDebugInfo() {
		...
		stringWriter.getBuffer().append("(p").append(begin).append("-p").append(end).append("):");
		try {writeTo(stringWriter);} catch (IOException ex) {} // IOException never occurs in StringWriter
