...
public final class FormControlType {
	 ...
	 * </dl>
	 */
	public static final FormControlType BUTTON=new FormControlType("button",HTMLElementName.BUTTON,true,true);
	 ...
	 * </dl>
	 */
	public static final FormControlType IMAGE=new FormControlType("image",HTMLElementName.INPUT,true,true);
	 ...
	 * </dl>
	 */
	public static final FormControlType TEXT=new FormControlType("text",HTMLElementName.INPUT,false,false);
	 ...
	 * </dl>
	 */
	public static final FormControlType TEXTAREA=new FormControlType("textarea",HTMLElementName.TEXTAREA,false,false);
	...
	static {
		...
		INPUT_ELEMENT_TYPE_MAP.put("button",NON_FORM_CONTROL);
